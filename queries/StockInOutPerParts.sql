SELECT 
        Product.Name, 
        Product.PartNumber, 
        SUM(CASE WHEN stock.Type = 0 THEN stock.Quantity ELSE 0 END) AS stockIn, 
        COUNT(CASE WHEN stock.Type = 0 THEN 1 END) AS stockInTimes,
        SUM(CASE WHEN stock.Type = 1 THEN stock.Quantity ELSE 0 END) AS stockOut,
        COUNT(CASE WHEN stock.Type = 1 THEN 1 END) AS stockOutTimes,
