...
OEE_by_Station_per_Week = Blueprint("OEE_by_Station_per_Week", __name__)

@OEE_by_Station_per_Week.route("/api/OEE_by_Station_per_Week", methods=["GET"])
def get_OEE_by_Station_per_Week():
    today = date.today()
